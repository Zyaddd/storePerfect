...
import com.example.storePerfect.Model.Products;
import com.example.storePerfect.Prevalent.Prevalent;
...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addToCartBtn = findViewById(R.id.pd_add_tocart_btn);
        numberButton = findViewById(R.id.number_btn);
        productImage = findViewById(R.id.product_image_details);
        productName = findViewById(R.id.product_name_details);
        productDescription = findViewById(R.id.product_description_details);
        productPrice = findViewById(R.id.prdocut_price_details);
        productStock = findViewById(R.id.product_stock_details);
